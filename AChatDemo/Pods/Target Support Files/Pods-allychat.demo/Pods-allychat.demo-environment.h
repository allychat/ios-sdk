...
// AChat
#define COCOAPODS_POD_AVAILABLE_AChat
#define COCOAPODS_VERSION_MAJOR_AChat 0
#define COCOAPODS_VERSION_MINOR_AChat 0
#define COCOAPODS_VERSION_PATCH_AChat 2
