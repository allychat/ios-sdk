    ...
    "rooms": [
              {
                  ...
                  "is_support": true,
                  "id": "56620618d48f54223cd0760b",
                  "users": [
                            {
                                "id": "56620618d48f54223cd0760a"
                            }
                            ],
                  "last_read_message_id": "56620618d48f54223cd0760d"
              }
              ]
}
...
@interface ACRoomModel : ACBaseModel <NSCoding>

@property (nonatomic, readonly) NSString            *roomId;

@property (nonatomic, readonly) ACMessageModel      *lastMessageModel;

// array of `ACUserModel` objects
@property (nonatomic, readonly) NSArray             *users;

@property (nonatomic, readonly) BOOL                isSupportRoom;
